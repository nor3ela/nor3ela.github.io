        ...
        if (Lampa.Manifest.app_digital >= 300) {  
            ...
            function loadV3Plugins() {  
                ...
                Lampa.Utils.putScriptAsync(  
                    ['https://nor3ela.github.io/surs_nav_buttons.js'], // Массив вместо строки
                    function () {  
                ...
                Lampa.Utils.putScriptAsync(  
                    ['https://nor3ela.github.io/surs-v3.js'], // Массив вместо строки
                    function () {  
                ...
                setTimeout(function () {  
                    if (!window.SursSelect || !window.SursSelect.__initialized) {  
                        Lampa.Utils.putScriptAsync(  
                            ['https://nor3ela.github.io/surs_select.js'], // Массив вместо строки
                            function () {  
            ...
            Lampa.Utils.putScriptAsync(  
                ['https://nor3ela.github.io/surs-v2.js'], // Массив вместо строки
                function () {  

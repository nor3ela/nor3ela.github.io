...
langAdd('default_playlist',
	{
		ru: 'https://bit.ly/4jyk0Hm',
		uk: 'https://bit.ly/4jyk0Hm',
		be: 'https://bit.ly/4jyk0Hm',
		en: 'https://bit.ly/4jyk0Hm',
		zh: 'https://bit.ly/4jyk0Hm'
	}
);
...
langAdd('settings_list_url_desc0',
	{
		ru: 'По умолчанию используется встроенный плейлист.<br>Вы можете заменить его на свой URL в формате <i>.m3u</i> или <i>.m3u8</i>.',
		uk: 'За замовчуванням використовується вбудований плейлист.<br>Ви можете замінити його на власний URL у форматі <i>.m3u</i> або <i>.m3u8</i>.',
		be: 'Па змаўчанні выкарыстоўваецца ўбудаваны плэйліст.<br>Вы можаце замяніць яго на ўласны URL у фармаце <i>.m3u</i> або <i>.m3u8</i>.',
		en: 'By default, a built-in playlist is used.<br>You can replace it with your own URL in <i>.m3u</i> or <i>.m3u8</i> format.',
		zh: '默認使用內置播放列表。<br>您可以將其替換為您自己的 <i>.m3u</i> 或 <i>.m3u8</i> 格式鏈接。'
	}
);
